...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[30rem] flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
      style={{
        position: 'relative'
      }}>
      {/* Gradient to black at the bottom */}
      <div
        style={{
          position: 'absolute',
          bottom: 0,
      ...
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-cyan-600 blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] "></motion.div>
